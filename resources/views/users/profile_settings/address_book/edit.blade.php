...
<div class="container">
	<div class="col-md-12 menu-container">
		...
		<form action="/my/address_book/update/{{$shipping->id}}" id="create-address" method="POST">
			<table class="table table-borderless">
				...
				<tr>
					...
					<td>
						<input type="text" name="landmark" class="form-control" value="{{$shipping->landmark}}">
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<input type="tel" name="pincode" max="6" class="form-control" value="{{$shipping->pincode}}" required>
					</td>
				</tr>
				<tr>
					<td></td>
